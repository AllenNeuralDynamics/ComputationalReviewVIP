...
## 8.1 The canonical in-vivo story, and why the in-vivo record fractures it
...
## 8.2 Locomotion and arousal: four metrics, one region, no common axis
...
### 8.2.1 Amplitude versus prevalence versus correlation
...
### 8.2.2 The state-specificity dispute: Fu versus Jackson
...
### 8.2.3 Does locomotion recruitment depend on visual input?
...
### 8.2.4 Arousal is not locomotion: the Khoury and Dipoppa refinements
...
### 8.2.5 Hippocampal and non-V1 heterogeneity
...
## 8.3 Reinforcement coding: reward and punishment are not one signal
...
### 8.3.1 The cortex-wide extension
...
### 8.3.2 The Ramamurthy S1 conflict
...
### 8.3.3 Regional and task-specific reinforcement signatures
...
## 8.4 Task engagement, strategy, and state transitions
...
## 8.5 Causal perturbations: what VIP silencing actually shows
...
### 8.5.1 The BLA test — VIP-specific, acute, but not in cortex
...
### 8.5.2 The A1 test — broader than VIP
...
### 8.5.3 The developmental test — chronic, not acute
...
### 8.5.4 Negative and null results
...
## 8.6 Two-photon population dynamics across tasks
...
## 8.7 What the in-vivo record supports, contests, and leaves untested
...
### 8.7.1 Implications for the review's thesis
...
### 8.7.2 What a replication-ready in-vivo protocol would look like
