...
**Background.** Vasoactive intestinal peptide (VIP)-expressing GABAergic interneurons are a minority cortical population — roughly 10–15% of cortical inhibitory cells — that has nevertheless acquired outsized theoretical weight. A small set of landmark mouse studies in primary sensory and medial prefrontal cortex established a disinhibitory motif in which VIP interneurons inhibit somatostatin (SST) interneurons, releasing pyramidal dendrites during behaviourally relevant events. The motif has since been propagated into reviews and computational models as a cortex-wide, subtype-indifferent principle — a "universal cortical disinhibitor" framing.

**Scope.** This review synthesises evidence across twelve axes — molecular taxonomy, developmental origin, morphology, intrinsic electrophysiology, synaptic connectivity, circuit motifs, in-vivo dynamics, brain-region context, oscillations, species translation and disease, computational models, and formal cross-cluster synthesis — to adjudicate where the framing holds and where it overreaches.
